...
run curl -O "https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini" \
 && curl -O "https://github.com/krallin/tini/releases/download/${TINI_VERSION}/tini.asc" \
 && gpg \
